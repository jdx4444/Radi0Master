...
# Prompt for the non-root username. This will be used for updating user's .bashrc,
# setting up radi0 build directory, and autostart.
read -p "Enter the target non-root username (for home directory paths): " TARGET_USER
...
echo "Using user ${TARGET_USER} (home: ${USER_HOME}) for configuration."
...
# Define the Radi0 directory based on the target user's home.
